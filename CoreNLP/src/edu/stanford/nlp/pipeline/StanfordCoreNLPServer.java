...
public class StanfordCoreNLPServer implements Runnable {
  ...
  public void run(Optional<Pair<String,String>> basicAuth,
    ...
    try {
      ...
      withAuth(server.createContext(uriContext+"/js/brat/style-vis.cs", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/style-vis.css", "text/css")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/head.load.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/head.load.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery.ba-bbq.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery.ba-bbq.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery.json.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery.json.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery.sprintf.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery.sprintf.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery.svg.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery.svg.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery.svgdom.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery.svgdom.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery-1.7.1.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery-1.7.1.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/jquery-ui.min.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/jquery-ui.min.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/lib/webfont.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/lib/webfont.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/ajax.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/ajax.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/annotation_log.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/annotation_log.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/annotator_ui.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/annotator_ui.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/configuration.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/configuration.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/dispatcher.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/dispatcher.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/offline_ajax.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/offline_ajax.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/spinner.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/spinner.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/url_monitor.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/url_monitor.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/util.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/util.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/visualizer.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/visualizer.js", "application/javascript")), basicAuth);
      withAuth(server.createContext(uriContext+"/js/brat/client/src/visualizer_ui.js", new FileHandler("edu/stanford/nlp/pipeline/demo/js/brat/client/src/visualizer_ui.js", "application/javascript")), basicAuth);
